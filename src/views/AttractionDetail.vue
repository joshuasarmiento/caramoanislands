  ...
  <div class="container py-12 mt-20">
    <div v-if="attraction" class="max-w-5xl mx-auto px-4">
      ...
      <div class="relative rounded-3xl overflow-hidden shadow-2xl mb-12">
        <div class="hero-carousel glide">
          <div class="glide__track" data-glide-el="track">
            <ul class="glide__slides">
              <li v-for="(imgSrc, index) in (attraction.images || [attraction.image])" :key="index"
                ...
                <img :src="imgSrc" :alt="`${attraction.name} - ${index + 1}`"
          ...
          <div v-if="(attraction.images || []).length > 1"
            ...
            <button v-for="(_, index) in attraction.images" :key="index"
        ...
        <!-- Overlay Text -->
        <div
          class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent pointer-events-none flex flex-col justify-start px-8 md:px-12 md:pb-12">
          <p class="mt-6 text-[10px] text-gray-200 italic">
            Image External Link (Check Legal Disclaimer for Copyright)
          </p>
        </div>
        <div
          class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent pointer-events-none flex flex-col justify-end p-8 md:p-12">
          <div class="flex flex-wrap gap-3 mb-4">
            <span
              class="bg-blue-600 text-white text-[10px] md:text-xs font-bold px-3 py-1 rounded-full uppercase tracking-widest shadow-sm">
              {{ attraction.group }}
            </span>
            <span
      ...
      <div class="grid lg:grid-cols-3 gap-12">
        <!-- Left Column: Description + Highlights + Social Media -->
        <div class="lg:col-span-2 space-y-12">
          ...
          <div>
            ...
            <div class="grid sm:grid-cols-2 gap-4">
              <div v-for="hl in attraction.highlights" :key="hl"
                class="flex items-center gap-3 bg-[--ocean]/5 p-4 rounded-xl border border-[--ocean]/10 hover:bg-[--ocean]/10 transition-colors">
          ...
          <!-- SOCIAL MEDIA BUTTONS - Only show if data exists -->
          <div v-if="hasSocial" class="pt-6 border-t border-[--ocean]/20">
            ...
            <div class="flex flex-wrap gap-4">
              ...
              <a v-if="attraction.socialMedia.instagram" :href="attraction.socialMedia.instagram" target="_blank"
                rel="noopener noreferrer"
                class="inline-flex items-center gap-3 bg-gradient-to-r from-[#f09433] via-[#e6683c] to-[#dc2743] text-white px-6 py-3 rounded-xl hover:brightness-110 transition-all shadow-md hover:shadow-lg">
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" class="w-6 h-6" fill="currentColor" viewBox="0 0 48 48">
                  <path fill="#304ffe"
        ...
        <div class="space-y-8 lg:sticky lg:top-24 h-fit">
          <!-- Citations Card -->
          <div class="p-8 rounded-3xl bg-[--ocean] text-[--ocean]/40 shadow-lg relative overflow-hidden">
            ...
            <ul class="space-y-4">
              <li v-for="cite in attraction.citations" :key="cite.source">
                <a :href="cite.link" target="_blank" rel="noopener noreferrer"
                  class="group flex flex-col gap-1 hover:text-blue-300 transition-colors">
          ...
          <!-- Visitor Tip Card -->
          <div class="p-8 rounded-3xl bg-[--ocean] text-[--ocean]/40 shadow-xl relative overflow-hidden">
    ...
    <div v-else class="text-center py-40">
      ...
      <button @click="goBack"
        class="px-8 py-4 bg-[--ocean] text-white rounded-full font-bold hover:bg-opacity-90 transition">
